/* ==============================
   Learn English App – Final Enhanced JS
   ============================== */
...
function saveProgress() {
  const progress = { username, selectedLevel, currentFileIndex, index };
...
function celebrate() {
  ...
  setTimeout(() => {
    ...
    if (nextFileExists) {
      ...
      statusMsg.textContent = `🏆 You’ve completed all levels! Fantastic
